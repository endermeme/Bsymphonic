...
public class JSymphonicWindow extends javax.swing.JFrame {
    ...
    public JSymphonicWindow() {
        ...
        showCustomWelcomeIfNeeded();
        
        logger.info("JSymphonic is ready!");
    }

    private void installSafeUIFont() {
        Font safeFont = new Font("Dialog", Font.PLAIN, 12);
        java.util.Enumeration keys = UIManager.getDefaults().keys();
        while (keys.hasMoreElements()) {
            Object key = keys.nextElement();
            Object value = UIManager.get(key);
            if (value instanceof javax.swing.plaf.FontUIResource) {
                UIManager.put(key, new javax.swing.plaf.FontUIResource(safeFont));
            }
        }
    }
   ...
   public void loadNewConfig(){
    ...
    private void initLang(){
        ...
        getLangMap().put("Tieng Viet", new Locale("vi", "VN"));
...
//        getLangMap().put("Česky", new Locale("cs", "CS"));
    ...
    private void showCustomWelcomeIfNeeded() {
        if (sHandler == null || sHandler.isCustomWelcomeShown()) {
            return;
        }
        ...
        messagePane.setText(java.util.ResourceBundle.getBundle("localization/misc").getString("CustomWelcomeDialog.html"));
        ...
        scrollPane.setPreferredSize(new java.awt.Dimension(520, 260));

        JOptionPane.showMessageDialog(
                this,
                scrollPane,
                java.util.ResourceBundle.getBundle("localization/misc").getString("CustomWelcomeDialog.title"),
                JOptionPane.INFORMATION_MESSAGE);

        sHandler.setCustomWelcomeShown(true);
    ...
    private void openExternalLink(String url) {
        ...
        try {
            ...
            logger.warning("Cannot open URL: " + url + " - " + ex.getMessage());
        } catch (URISyntaxException ex) {
            logger.warning("Invalid URL: " + url + " - " + ex.getMessage());
        }
    }
